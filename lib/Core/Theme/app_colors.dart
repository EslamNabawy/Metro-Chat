...
class AppColors {
  ...
  static const Color text = Colors.white; // Assuming you want white text on a dark background
  ...
  static const Color inputFillLight = Color(0xFF333333); // Darker background for inputs
  static const Color cardBackgroundLight = Color(0xFF333333); // Darker background for cards
